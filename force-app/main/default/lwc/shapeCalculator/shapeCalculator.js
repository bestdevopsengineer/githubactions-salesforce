...
{       const s= parseInt(this.side);       this.currentOutput='Area of the Square is: '+(s*s);    }   

 calculateRecAreaHandler()    {    const w=parseInt(this.width);    const h =parseInt(this.height);           
this.currentOutput='Area of the rectangle is '+(w*h);    }   

 calculateRhAreaHandler(){        const d1=parseInt(this.diagonal1);        const d2=parseInt(this.diagonal2);        this.currentOutput='Area of the rhombus is '+(d1*d2)/2;    }}
